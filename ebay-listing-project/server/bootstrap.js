...
async function bootstrap() {
  try {
    ...
    console.error('');
    console.error('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!');
    console.error('!!  DATABASE UNREACHABLE — NOTHING WILL BE SAVED                  !!');
    console.error('!!  Listings, eBay imports, sold syncs and settings will be lost !!');
    console.error('!!  when the server stops. Check MONGODB_URI and make sure the   !!');
    console.error('!!  MongoDB server it points at is running and reachable.        !!');
    console.error('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!');
    console.error('');
  }
}
