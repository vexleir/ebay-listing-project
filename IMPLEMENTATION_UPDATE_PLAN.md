...
**Current implementation phase:** MOB-001 (a–e) ✓, FE-004 follow-through ✓, INV-002 lite ✓, UX-002 focus-trap ✓, UX-002 lightbox a11y ✓, IMG-001 lite ✓, IMG-002 lite ✓, FE-003 test backfill ✓, IMG-001 crop ✓, IMG-001 aspect-ratio presets ✓, Quota middleware test backfill ✓, IMG-001 straighten ✓, IMG-003 slice 1 ✓, IMG-003 slice 2 ✓, ImageEditModal test backfill ✓, IMG-001 auto-enhance ✓, applicationToken test backfill ✓, INV-001 slice 1 ✓, INV-002 inventory-badge wire-up ✓, INV-002 inventory bootstrap on stage ✓, INV-002 push counter sync ✓, INV-002 sold-sync counter wiring ✓, AI quota admin controls ✓, INV-002 end-listing counter wiring ✓, **ImageEditModal upload bugfix ✓** (the "Failed to save images: {}" toast — pre-existing prefix-stripping bug in the Cloudinary upload + error path). Only the PWA shell remains under MOB-001. Frontend tests: **339 passing across 38 files**. Server tests: **334 passing**. Other high-leverage tickets: warn-before-push gating, OFFER-001/FULFILL-001 discovery, INTEL-001 (experiment schema), unified Image Studio refactor.
