...
**Current implementation phase:** MOB-001 (a–e) ✓, FE-004 follow-through ✓, INV-002 lite ✓, UX-002 focus-trap ✓, UX-002 lightbox a11y ✓, IMG-001 lite ✓, IMG-002 lite ✓, FE-003 test backfill ✓, IMG-001 crop ✓, IMG-001 aspect-ratio presets ✓, **Quota middleware test backfill ✓** (8 server-side cases for `server/middleware/quota.js`). Only the PWA shell remains under MOB-001. Frontend tests: **278 passing across 32 files**. Server tests: **196 passing**. Remaining IMG-001 scope: straighten, auto-enhance, unified Image Studio modal. Other high-leverage tickets: full INV-001/INV-002, OFFER-001/FULFILL-001 discovery, INTEL-001 (experiment schema).
