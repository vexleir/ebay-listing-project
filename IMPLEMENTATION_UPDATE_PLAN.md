...
**Current implementation phase:** MOB-001 (a–e) ✓, FE-004 follow-through ✓, INV-002 lite ✓, UX-002 focus-trap ✓, **UX-002 lightbox a11y ✓** (Lightbox now uses real buttons + focus trap + dialog semantics). Only the PWA shell remains under MOB-001. Frontend tests: **208 passing across 26 files**. Next high-leverage tickets: IMG-001 (in-browser crop/rotate), the full INV-001/INV-002 scope, or the eBay-API discovery sessions for OFFER-001/FULFILL-001.
