...
**Current implementation phase:** MOB-001 (a–e) ✓, FE-004 follow-through ✓, INV-002 lite ✓, UX-002 focus-trap ✓, UX-002 lightbox a11y ✓, IMG-001 lite ✓, IMG-002 lite ✓, FE-003 test backfill ✓, IMG-001 crop ✓, IMG-001 aspect-ratio presets ✓, Quota middleware test backfill ✓, IMG-001 straighten ✓, IMG-003 slice 1 ✓, IMG-003 slice 2 ✓, ImageEditModal test backfill ✓, IMG-001 auto-enhance ✓, applicationToken test backfill ✓, INV-001 slice 1 ✓, INV-002 inventory-badge wire-up ✓, INV-002 inventory bootstrap on stage ✓, INV-002 push counter sync ✓, INV-002 sold-sync counter wiring ✓, **AI quota admin controls ✓** (Settings panel now lets sellers adjust the per-day AI token cap or turn it off entirely; backend wires the disabled flag through `getAiDailyQuotaStatus` and `enforceAiDailyQuota`). Only the PWA shell remains under MOB-001. Frontend tests: **339 passing across 38 files**. Server tests: **322 passing**. Other high-leverage tickets: end-listing counter wiring, warn-before-push gating, OFFER-001/FULFILL-001 discovery, INTEL-001 (experiment schema), unified Image Studio refactor.
