      ...
      <div className="action-row-stack" style={{ marginTop: '2rem' }}>
        ...
        <button className="btn-primary" style={{ flex: 2 }} disabled={title.length > 80}
          onClick={() => {
            ...
            onStage({ title, condition, description, category, priceRecommendation, priceJustification, shippingEstimate, itemSpecifics, images: allImages, sku, sellerNotes, costBasis, shippingLabelCost, tags, quantity: qtyNum });
          }}>
